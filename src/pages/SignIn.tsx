        ...
        <Card className="shadow-medical border-border/50">
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-gradient-primary shadow-medical hover:opacity-90 transition-all">
                Sign In
              </Button>
            </form>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="hover:shadow-card transition-all">
